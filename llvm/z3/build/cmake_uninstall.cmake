if(NOT EXISTS "/files/llvm-rev/llvm/z3/build/install_manifest.txt")
  message(FATAL_ERROR "Cannot find install manifest: "
          "/files/llvm-rev/llvm/z3/build/install_manifest.txt")
endif()

file(READ "/files/llvm-rev/llvm/z3/build/install_manifest.txt" files)
...
foreach(file ${files})
  ...
  if(IS_SYMLINK "${_full_file_path}" OR EXISTS "${_full_file_path}")
    ...
    execute_process(COMMAND
      "/home/avery/.local/share/JetBrains/Toolbox/apps/CLion/ch-0/222.3739.54/bin/cmake/linux/bin/cmake" "-E" "remove" "${_full_file_path}"
